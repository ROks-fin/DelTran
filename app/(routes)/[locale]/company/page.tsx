/**
 * Company Page - Server Component
 *
 * Performance Strategy:
 * 1. Hero section server-rendered for fast LCP
 * 2. Client sections loaded dynamically
 * 3. No framer-motion in critical path
 * 4. ISR with 1-hour revalidation for caching
 */
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    title: t('meta.title').replace(' - DelTran', ''),
...
// Dynamic import for client-side sections
const CompanyPageClient = dynamic(
  () => import('./CompanyPageClient').then(mod => mod.CompanyPageClient),
  {
...
export default async function CompanyPage({
  ...
  return (
    <div className="relative overflow-x-hidden">
      {/* Hero Section - Compact, banking-grade feel */}
