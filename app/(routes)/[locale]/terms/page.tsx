...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    ...
    description: 'DelTran Terms of Service. Our legal terms, conditions, and agreements governing the use of our settlement infrastructure services.',
    path: '/terms',
...
export default async function TermsPage({
  ...
  const sectionsWithItems = ['userObligations'];
