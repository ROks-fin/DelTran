    ...
    <div className="space-y-8">
      ...
      <div className="text-center mb-12">
        <motion.div
          ...
          className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-gold/20 to-gold-light/20 border border-gold/40 backdrop-blur-sm mb-6"
        >
            ...
            return (
              ...
              >
                ...
                <div className={`md:w-1/2 ml-20 md:ml-0 ${isLeft ? 'md:pr-16' : 'md:pl-16'}`}>
                  <Card
                    className={`p-8 bg-gradient-to-br ${getPhaseColor(phase.status)} transition-all duration-300 ${
